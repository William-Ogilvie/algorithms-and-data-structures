...
def basic_benchmark(n1: int, n2: int, func, *args, **kwargs):
    ...
    time_taken_n1 = timeit.timeit(lambda: func(n1_test_array, *args, **kwargs), number = 100)
    time_taken_n2 = timeit.timeit(lambda: func(n2_test_array, *args, **kwargs), number = 100)
