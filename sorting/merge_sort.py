...
print(f"10 (1 + log 10 / log n1) is approx 13.33, the experimental factor we got was 64.1108, this is much larger and may be to do with python overhead rather than the algorithm iteslf.")
